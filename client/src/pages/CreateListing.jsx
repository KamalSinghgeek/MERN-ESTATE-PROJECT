...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
     ...
     <input type="text" placeholder='Name' className='border p-3
      ...
      <div className='flex flex-wrap gap-6'>
        ...
        className='p-3 border-grey-300 rounded-lg' onChange={handleChange} value={formData.bedrooms}/>
        <p>Beds</p>
        </div>
        <div className='flex items-center gap-2'>
        <input type='number' id='bathrooms' min='1' max='10' required
        className='p-3 border-grey-300 rounded-lg' onChange={handleChange} value={formData.bathrooms}/>
        <p>Baths</p>
        </div>
        <div className='flex items-center gap-2'>
    ...
    className='p-3 border border-gray-300 rounded w-full' type="file" id='image' accept='image/*' multiple />
