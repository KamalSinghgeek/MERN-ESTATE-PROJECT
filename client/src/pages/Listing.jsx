  ...
  return (
    <main>
      ...
      {listing && !loading && !error && (
        ...
        rounded-md bg-slate-100 p-2'> Link copied!</p>
        )}
        ...
        <ul className=' text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
          <li className='flex itmes-center gap-1 whitespace-nowrap'>
        ...
        <button onClick={()=> setContact(true)}
         ...
         rounded-lg uppercase hover:opacity-90 p-3'>Contact LandLord</button>
